...
import hashlib
import json
import stat # <--- TAMBAHKAN IMPORT INI
...
# =================================================================
# === TAMBAHKAN FUNGSI PENOLONG INI ===
def handle_remove_readonly(func, path, exc_info):
    """Fungsi ini dipanggil jika shutil.rmtree gagal karena file terkunci."""
...
def main():
    ...
    # =================================================================
    # === PERUBAHAN DI SINI: Gunakan onerror untuk menghapus folder ===
    ...
    if os.path.isdir(VENV_FOLDER):
        ...
        shutil.rmtree(VENV_FOLDER, onerror=handle_remove_readonly)
    # =================================================================
